...
{    
    public class AuthService : IAuthService
    {
        ...
        public AuthService(YoutubeDlContext context, IOptions<AppSettings> appSettings, IUserRepository userRepository)
        {
            _context = context;
        ...
        public bool UsernameAvailableAsync(string username)
        {
            var users = _context.Users.ToList();
            return users.FirstOrDefault(x => x.Username is not null && x.Username.Equals(username)) is null;
        }
    }
}
